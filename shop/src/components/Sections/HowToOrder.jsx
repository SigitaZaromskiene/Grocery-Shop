...
function HowToOrder() {
  return (
    <div className="order_section_container wrapper" >
      ...
      <p className="order_section_container_secondary_heading">Here's how to shop in 3 simple steps</p>
      </div>
      <div className="order_section_container_steps_container">
        <div className="order_section_container_steps_container_step">
          <h5>Join for free</h5>
          <img src={photo1} alt='Join for free'/>
          <p>
